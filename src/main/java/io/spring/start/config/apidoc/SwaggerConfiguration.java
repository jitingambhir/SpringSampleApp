package io.spring.start.config.apidoc;
...
import io.spring.start.config.ApplicationProperties;
...
public class SwaggerConfiguration {
     ...
     */
    @Bean
    public Docket swaggerSpringfoxDocket(ApplicationProperties jHipsterProperties) {
