...
public class ApplicationProperties {
    ...
    public static class Mail {
        ...
        private String from = "ChatAnalysis@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ChatAnalysis API";

        private String description = "ChatAnalysis API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ChatAnalysis";
